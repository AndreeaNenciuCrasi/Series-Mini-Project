...
import com.example.seriesminiproject.repository.EpisodeRepositoryJPA;
...
public class SeriesMiniProjectApplication {
    ...
    public static void main(String[] args) {
        ...
        EpisodeRepositoryJPA episodeRepositoryJPA = configurableApplicationContext.getBean(EpisodeRepositoryJPA.class);
        ...
        System.out.println(episodeRepositoryJPA.findByDuration(70));
